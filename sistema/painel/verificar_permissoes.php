...
if($qr_code == 'ocultar'){
	$menu_whatsapp = 'ocultar';
}else{
	$menu_leads = '';
}

if($leads == 'ocultar' and $ninchos == 'ocultar'){
	$menu_leads = 'ocultar';
}else{
	$menu_leads = '';
}
...
if($receber == 'ocultar' and $pagar == 'ocultar' and $rel_balanco == 'ocultar' and $rel_sintetico_despesas == 'ocultar' and $rel_sintetico_receber == 'ocultar' and $rel_financeiro == 'ocultar' and $rel_inadimplementes == 'ocultar' and $lista_vendas == 'ocultar' and $comissoes == 'ocultar'){
