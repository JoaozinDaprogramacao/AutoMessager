				...
				<aside class="app-sidebar">
					...
					<div class="main-sidemenu">
						...
						<ul class="side-menu">
							...
							<li class="slide <?php echo @$menu_whatsapp ?>">
								<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
									<i class="fa fa-whatsapp mt-1"></i>
									<span class="side-menu__label" style="margin-left: 15px">WhatsApp</span><i class="angle fe fe-chevron-right"></i></a>
								<ul class="slide-menu">
									<li class="<?php echo @$qr_code ?>"><a class="slide-item" href="qr_code"> Qr Code</a></li>
									<li class="<?php echo @$enviar_mensagem ?>"><a class="slide-item" href="enviar_mensagem"> Enviar Mensagem</a></li>
								</ul>
							</li>


							<li class="slide <?php echo @$menu_leads ?>">
								<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
									<i class="fa fa-lightbulb-o text-white mt-1"></i>
									<span class="side-menu__label" style="margin-left: 15px">Leads</span><i class="angle fe fe-chevron-right"></i></a>
								<ul class="slide-menu">

									<li class="<?php echo @$leads ?>"><a class="slide-item" href="leads"> Leads</a></li>
									<li class="<?php echo @$ninchos ?> "><a class="slide-item" href="ninchos"> Ninchos</a></li>
								</ul>
							</li>
							...
							<li class="slide <?php echo @$menu_cadastros ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$unidade_medida ?> "><a class="slide-item" href="unidade_medida"> Unidade de Medidas</a></li>
							...
							<li class="slide <?php echo @$menu_produtos ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$ordem_compra ?>"><a class="slide-item" href="ordem_compra"> Ordem de Compra</a></li>

									<li class="<?php echo @$categorias ?> "><a class="slide-item" href="categorias"> Categorias</a></li>

									<li class="<?php echo @$entradas ?> "><a class="slide-item" href="entradas"> Entrada de Produtos</a></li>

									<li class="<?php echo @$saidas ?> "><a class="slide-item" href="saidas"> Saída de Produtos</a></li>
							...
							<li class="slide <?php echo @$vendas ?>">
								<a class="side-menu__item" href="vendas">
									<i class="fa fa-money text-white"></i>
									<span class="side-menu__label" style="margin-left: 15px">Vendas</span></a>
							</li>


							<li class="slide <?php echo @$orcamento ?>">
								<a class="side-menu__item" href="orcamento">
									<i class="fa fa-file text-white"></i>
									<span class="side-menu__label" style="margin-left: 15px">Orçamentos / Pedidos</span></a>
							</li>
				...
				<div class="modal-body">
					...
					<div class="row mb-3">
						...
						<div class="col-md-3">
							<label>
								...
								Api Whatsapp <a href="#" onclick="testarApi()" title="Testar disparo Api"><i class="fa fa-whatsapp text-verde"></i></a>
							</label>
					...
					<div class="row mb-3">
						...
						<div class="col-md-6">
							...
							<input type="text" class="form-control" id="comissao_sistema" name="comissao_sistema" placeholder="Ex: 5 ou 5,5" value="<?php echo @$comissao_sistema ?>" onkeyup="mascara_decimal('comissao_sistema')">
						</div>
