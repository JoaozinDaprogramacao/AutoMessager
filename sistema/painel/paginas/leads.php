...
<div class="justify-content-between">
	<div class="left-content mt-2 mb-3">
		...
		<a class="btn ripple btn-primary text-white" onclick="inserir_massa()" type="button"><i class="fe fe-plus me-2"></i> Em Massa </a>
		...
		<a style="position:absolute; right:40px;" href="rel/excel_leads.php" type="button" class="btn btn-success ocultar_mobile_app" target="_blank"><span class="fa fa-file-excel-o"></span> Exportar</a>
...
<?php
$query = $pdo->query("SELECT * from ninchos order by nome asc");
...
?>
	<ul class="nav nav-tabs" id="myTab" role="tablist" style="background: #FFF">
		...
		<li class="nav-item" role="presentation">
			<a onclick="buscarNin('')" class="nav-link active" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Todos</a>
		</li>
		...
		?>
			...
			<li class="nav-item" role="presentation">
				<a onclick="buscarNin('<?php echo $id ?>')" class="nav-link " id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"><?php echo $nome ?></a>
			</li>
		<?php } ?>
	</ul>
<?php } ?>
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6 mb-2 col-6">
							<label>Nome Lead</label>
							<input type="text" class="form-control" id="nome" name="nome" placeholder="Nome do Lead" required>
						</div>

						<div class="col-md-3 col-6">
							<label>Telefone</label>
							<input type="text" class="form-control" id="celular" name="celular" placeholder="Celular do Lead" required maxlength="15">
						</div>
...
<div class="modal fade" id="modalForm-massa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel"><span id="titulo_inserir_massa"></span></h4>
				<button id="btn-fechar-massa" aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span class="text-white" aria-hidden="true">&times;</span></button>
			</div>
			<form id="form_massa">
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-3 mb-2">
							...
							<select class="form-select" name="nincho-massa" id="nincho-massa" style="width:100%">
								<option value="0">Escolher Nincho</option>
								<?php
								$query = $pdo->query("SELECT * from ninchos order by id asc");
								$res = $query->fetchAll(PDO::FETCH_ASSOC);
						...
						<div class="col-md-6 mb-2">
							<label>Importar Planilha (.xlsx)</label>
							<input type="file" class="form-control" id="planilha" name="planilha" accept=".xlsx" required>
						</div>
					</div>
				...
				<br>
				<small>
					<div id="mensagem_massa" align="center"></div>
				</small>
				<div class="modal-footer">
					<button type="submit" id="btn_salvar_massa" class="btn btn-primary">Salvar</button>
				</div>
			</form>
						...
						<div class="tile">
							<div class="table-responsive">
								<table id="" class="text-left table table-bordered">
									<tr>
										<td class="bg-warning alert-warning">Celular</td>
										<td><span id="celular_dados"></span></td>
									</tr>
