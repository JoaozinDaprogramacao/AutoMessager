			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4 mb-2 col-6">							
							...
							<select class="sel2" name="fornecedor" id="fornecedor" style="width:100%">
								<option value="0">Escolher Fornecedor</option>
								<?php 
								$query2 = $pdo->query("SELECT * from fornecedores order by id asc");
								$res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
								$linhas = @count($res2);
								if($linhas > 0){
									for($i=0; $i<$linhas; $i++){ ?>
										<option value="<?php echo $res2[$i]['id'] ?>"><?php echo $res2[$i]['nome'] ?></option>
									<?php } } ?>
								</select>			
							</div>
					...
					<div class="row">
						...
						<div class="col-md-3 mb-2 col-7">							
							<label>Tem Estoque</label>
							<select class="form-select" name="tem_estoque" id="tem_estoque" required>					<option>Não</option>			
								<option>Sim</option>								
								</select>								
							</div>
						...
						<div class="col-md-3 mb-2 col-12">							
								...
								<input type="text" class="form-control" id="estoque_minimo" name="estoque_minimo" placeholder="Estoque Mínimo" onkeyup="mascara_decimal('estoque_minimo')">							
						</div>

						<div class="col-md-3 mb-2 col-12">							
								<label>Estoque</label>
								<input type="text" class="form-control" id="estoque" name="estoque" placeholder="Estoque" onkeyup="mascara_decimal('estoque')">							
						</div>
						...
						<div class="col-md-3 mb-2 col-6">							
							...
							<select class="form-select" name="unidade" id="unidade">
								...
								<?php 
								$query3 = $pdo->query("SELECT * from unidade_medida order by id asc");
								$res3 = $query3->fetchAll(PDO::FETCH_ASSOC);
								$linhas = @count($res3);
								if($linhas > 0){
									for($i=0; $i<$linhas; $i++){ ?>
										<option value="<?php echo $res3[$i]['id'] ?>"><?php echo $res3[$i]['nome'] ?></option>
									<?php } } ?>
								</select>			
							</div>


							<div class="col-md-3 mb-2 col-5">							
								<label>Valor Compra R$</label>
								<input type="text" class="form-control" id="valor_compra" name="valor_compra" placeholder="R$ Valor Da Compra" required onkeyup="mascara_moeda('valor_compra')">							
						</div>


							<div class="col-md-3 mb-2 col-5">							
								<label>Valor Venda R$</label>
								<input type="text" class="form-control" id="valor_venda" name="valor_venda" placeholder="R$ Valor Da Venda" onkeyup="mascara_moeda('valor_venda')">							
						</div>	
					...
					<div class="row">
							...
							<div class="col-md-3 mb-2 col-5">							
								<label>Valor Sem Promoção</label>
								<input type="text" class="form-control" id="valor_sem_promocao" name="valor_sem_promocao" placeholder="R$ Valor antigo" onkeyup="mascara_moeda('valor_sem_promocao')">							
						</div>	

						<div class="col-md-6 mb-2 col-8" >						
							...
							<div class="tile">
								<div class="table-responsive">
									<table id="" class="text-left table table-bordered">
										...
										<tr>
											<td class="bg-warning alert-warning">Fornecedor</td>
										...
										<tr>
											<td class="bg-warning alert-warning w_150">Valor Compra</td>
											<td><span id="valor_compra_dados"></span></td>
										</tr>

										<tr>
											<td class="bg-warning alert-warning w_150">Valor Venda</td>
										...
										<tr>
											<td class="bg-warning alert-warning w_150">Unidade de Medida</td>
											<td><span id="unidade_dados"></span></td>
										</tr>
