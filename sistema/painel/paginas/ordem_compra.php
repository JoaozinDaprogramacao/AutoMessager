...
<div class="justify-content-between">
	<form action="rel/lista_ordem_compra_class.php" target="_blank" method="POST">
 	<div class="left-content mt-2 mb-3">
 <a style="margin-bottom: 10px; margin-top: 5px" class="btn ripple btn-primary text-white <?php echo $inserir_orcamentos ?>" onclick="inserir()" type="button"><i class="fe fe-plus me-2"></i>Nova Ordem Compra</a>
...
<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    ...
    <a onclick="buscar($('#tipo_busca').val('Aprovada'))" class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Aprovadas</a>
    <a onclick="buscar($('#tipo_busca').val('Pendente'))" class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Pendentes</a>
  </div>
</nav>
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="form-group"> 
									<label>Forma PGTO</label> 
									<select class="sel_forn" name="fornecedor" id="fornecedor" style="width:100%" >	
...
<div style="display:none">
	<form action="rel/ordem_compra_class.php" method="POST" target="_blank">
