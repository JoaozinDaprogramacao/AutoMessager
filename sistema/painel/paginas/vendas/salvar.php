...
if($valor_restante > 0){
	$pdo->query("INSERT INTO receber SET descricao = 'Nova Venda', valor = '$valor_pago', vencimento = '$data', data_lanc = curDate(), data_pgto = '$data_pgto', usuario_lanc = '$id_usuario', arquivo = 'sem-foto.png', pago = '$pago', usuario_pgto = '$usuario_pgto', cliente = '$cliente', referencia = 'Venda', hora = curTime(), forma_pgto = '$saida', desconto = '$desconto', troco = '$troco', frete = '$frete', tipo_desconto = '$tipo_desconto', subtotal = '$subtotal_venda', valor_restante = '$valor_restante', forma_pgto_restante = '$forma_pgto2', data_restante = '$data_restante', caixa = '$id_caixa'");
	...
	$pdo->query("INSERT INTO receber SET descricao = 'Nova Venda (Restante)', valor = '$valor_restante', vencimento = '$data_restante', data_lanc = curDate(), data_pgto = '$data_pgto2', usuario_lanc = '$id_usuario', arquivo = 'sem-foto.png', pago = '$pago2', usuario_pgto = '$usuario_pgto2', cliente = '$cliente', referencia = 'Venda', hora = curTime(), forma_pgto = '$forma_pgto2', desconto = '$desconto', troco = '$troco', frete = '$frete', tipo_desconto = '$tipo_desconto', subtotal = '$subtotal_venda', valor_restante = '$valor_pago', forma_pgto_restante = '$saida', data_restante = '$data', id_ref = '$id_venda', caixa = '$id_caixa'");


}else{
	$pdo->query("INSERT INTO receber SET descricao = 'Nova Venda', valor = '$subtotal_venda', vencimento = '$data', data_lanc = curDate(), data_pgto = '$data_pgto', usuario_lanc = '$id_usuario', arquivo = 'sem-foto.png', pago = '$pago', usuario_pgto = '$usuario_pgto', cliente = '$cliente', referencia = 'Venda', hora = curTime(), forma_pgto = '$saida', desconto = '$desconto', troco = '$troco', frete = '$frete', tipo_desconto = '$tipo_desconto', subtotal = '$subtotal_venda', caixa = '$id_caixa'");
	$id_venda = $pdo->lastInsertId();
}
